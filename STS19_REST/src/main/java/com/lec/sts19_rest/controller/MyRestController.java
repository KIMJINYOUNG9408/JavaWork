...
public class MyRestController {
	...
	public BWriteDTO helloJSON() {
		BWriteDTO dto =
				new BWriteDTO(100, "안녕하세요", "REST", "JSON이다", 123 , new Timestamp(10000));
	...
	public EmployeeListVO listXML() {
		...
		EmployeeVO emp2 = new EmployeeVO(2, "클레어", 30, new int[] {10,50,90},23.2);		
		EmployeeVO emp3 = new EmployeeVO(3, "크리스", 25, new int[] {100,50,90},45.2);	
