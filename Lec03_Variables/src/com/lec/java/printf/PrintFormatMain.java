...
public class PrintFormatMain {
	...
	public static void main(String[] args) {
		...
		System.out.println();
		// String.format()
		String.format("합격률은 %.1f%% 입니다.", rate); // 화면 출력용이 아님 
		String result = String.format("합격률은 %.1f%% 입니다.", rate); // String 변수에 문자열을 담는다.
