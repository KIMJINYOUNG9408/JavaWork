...
//	  	byte num4 = 1234; // 에러 : byte 에 저장할 수 있는 크기를 넘어섬
	  	...
	  	short num5 = -12345;
	  	short num6 = 12345;
//	  	short num7 = 32768; // 에러 : short 에 저장할 수 있는 크기를 넘어섬
...
//	  	int num15 = 12L;  // long 타입을 int에 대입 불가.
	  	...
	  	System.out.println("number1 = " + String.format("%x", number1)); // number1을 16진수로 출력
	  	System.out.println("number1 = " + String.format("%o", number1)); // number1을 8진수로 출력
