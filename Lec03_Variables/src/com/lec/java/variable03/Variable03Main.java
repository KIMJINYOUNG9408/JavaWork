...
public class Variable03Main {
	public static void main(String[] args) {
		...
		// 실수 타입 최소, 최대값
		System.out.println("float : " + Float.MIN_VALUE + " ~ " + Float.MAX_VALUE); // 1.4 X 10의 -45승 ~  
		System.out.println("double : " + Double.MIN_VALUE + " ~ " + Double.MAX_VALUE); // 4.9 X 10의-324승~
		...
		double number9 = 1.213E-4; // 지수 표기법 1.2123 의 10의 -4승
