...
public class Collection09Main {
	...
	public static void main(String[] args) {
		...
		// subset() 메소드
		// 시작값과 끝 값을 매개변수로 받아, 그것을 범위로 , 부분 Set 추출
		System.out.println();
		TreeSet<Integer> subSet = (TreeSet<Integer>) tset.subSet(5, 14); // 5 부터 14 전까지
		// for(Integer e : subSet) {
		// System.out.println(e);
		// }
		System.out.println(subSet);

		subSet = (TreeSet<Integer>) tset.subSet(5,true, 14,true); // 5와 14를 포함하겟다는 뜻 
		System.out.println(subSet);
