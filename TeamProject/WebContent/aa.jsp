 ...
 <table width="900" height="650">
  <tr>
   <td width="100%" height="10%"><span style="padding-left: 160px"><img
    src="../log/image/itbanklogo.png" width="200" height="60" border="0"
  ...
  <tr>
   ...
   <b>ITBANK 개인정보입력</b>
   <br><br>
   ID : <input type="text" size="10" maxlength="15" name="id"> <button type="button"  onclick="idcheck()" align="middle">중복</button><br><br>
  ...
  <tr>
   <td align="center">
   <hr><br>
    <img src="image/regbutton.png" onclick="regChk()">&nbsp;
    <img src="image/reset.png" onclick="javascript:location.href='regFormImpl2.jsp'">&nbsp;
    <img src="image/regcancel.png" onclick="regCancel()">
   </td>
  </tr>
 </table>
</form>
