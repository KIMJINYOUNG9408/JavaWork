...
//		num4 = 500; // 에러 final로 되어있으니. 풀어도 어차피 에러남. effectively final <<
		// Local inner class
		class TestLocal {
			// 멤버 변수
...
//		num2 = 400;  // num2 값이 변경하면 .. 아래 showNumbers()에선 200이 찍혀야 하나 ? 400이 찍혀야하나?
		// 그래서 로컬내부클래스에서 사용가능한 지역의 변수는
		// 반드시 effectively final 이어야 한다.
		// 즉 한번 초기화 된후 값이 변경되지 않는다.
