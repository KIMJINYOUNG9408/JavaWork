...
public class Operator08Main {
	...
	public static void main(String[] args) {
		...
		byte n1 = 10; // 0000 1010        0000 1010      0000 1010
		byte n2 = 7;  // 0000 0111        0000 0111      0000 0111
	 	              //&----------      |----------    ^---------- 
					  // 0000 0010        0000 1111      0000 1101
		int result = n1 & n2;  
		System.out.println("& 결과 = " + result); // 결과는 10진수로 표현해줌
		System.out.println("& 결과 = " + Integer.toBinaryString(result)); // 결과는 10진수로 표현해줌
	    ...
	    result = ~n1;
	    System.out.println("~n1 결과 = " + result); // 결과는 10진수로 표현해줌
	    System.out.println("~n1 결과 = " + Integer.toBinaryString(result)); // 결과는 10진수로 표현해줌
		...
		System.out.println("n3 >> 1 결과 = " + result2);
		System.out.println("n3 >> 1 결과 = " + Integer.toBinaryString(result2));
