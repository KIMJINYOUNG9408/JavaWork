...
public class DB05Main implements Query {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 2. 쿼리연산(들) 수행
            stmt.executeUpdate("INSERT INTO test_member VALUES (test_member_seq.nextval, '1번째', SYSDATE)");
            stmt.executeUpdate("INSERT INTO test_member VALUES (test_member_seq.nextval, '2번째', SYSDATE)");
            stmt.executeUpdate("INSERT INTO test_member VALUES (test_member_seq.nextval, '', SYSDATE)");
            stmt.executeUpdate("INSERT INTO test_member VALUES (test_member_seq.nextval, '4번째', SYSDATE)");
			// 3. 정상적으로 완료되면 commit() 실행
