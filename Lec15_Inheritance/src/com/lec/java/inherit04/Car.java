...
public class Car extends Vehicle {
	...
	public Car() {
		...
		// 명시적으로 super 생성자가 없으면 부모의 기본 생성자를 ㅎ출하게 됨.
		
		System.out.println("Car() 생성");
	}
	
	public Car(int oil) {
		// super()는 반드시 생성자 코드의 첫번째 문장 이어야함.
		super(); // super : 부모를 의미, super() <-- 부모의 기본생성자 호출
		this.oil = oil;
		
		System.out.println("Car(int) 생성 : oil = " + oil + speed);
	}
	...
	public Car(double value) {
		...
		System.out.println("Car(double) 생성 : " +value);
	}
}
