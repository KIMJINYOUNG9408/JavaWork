...
//		System.out.println(안녕하세요); // 에러
		...
		System.out.println("결과: " + 10); // 줄 복사 : ctrl + alt + 방향키 , 줄 삭제 : ctrl + d
		...
		System.out.println("10 - 20 = " + (10 - 20));
		System.out.println("10 * 20 = " + (10 * 20));
		System.out.println("10 / 20 = " + (10 / 20)); // 정수 / 정수 결과 = 정수 (소숫점 이하 절삭)
		System.out.println("10 / 20 = " + (10. / 20)); // 정수 / 정수 결과 = 정수 (소숫점 이하 절삭)
		System.out.println("10 / 20 = " + ((double)10 / 20)); // 정수 / 정수 결과 = 정수 (소숫점 이하 절삭)
		
		// 이스 케이프 문자(escape character)
		// " ~ " 문자열 안에서 특수한 문자 출력 
		// 역슬래시(\) 와의 조합문자로 구성
		// \"  : 쌍따옴표 출력
		// \n  : 줄바꿈
