...
public class D {
	...
	// 특정 depth 의 특정 parent 인 카테고리를 읽어오기
	public static final String SQL_CATEGORY_BY_DEPTH_N_PARENT
		= "SELECT ca_uid \"uid\", ca_name name, ca_depth \"DEPTH\", ca_parent parent, ca_order \"order\" FROM test_category WHERE CA_DEPTH = ? AND CA_PARENT = ? ORDER BY CA_ORDER ASC;"; 
