...
public class RegExp01Main {
	...
	public static void main(String[] args) {
		...
		regex = "My...."; // My로 시작하고 임의의 문자 4개 = > 정규표현식
		pat = Pattern.compile(regex); // Patter 객체 pat 생성
		...
		// = 위의 코드를 다시 실행하면 ? 다음패턴부터 매칭을 시도하기 때문에 결과는 실패로 나온다.
		...
		System.out.println(matcher.replaceFirst("XXXX")); // 원래는 -My1234- My1234를 XXXX로 바꿔서 -XXXX- 출력
