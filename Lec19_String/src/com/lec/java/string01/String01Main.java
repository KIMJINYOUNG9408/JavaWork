...
public class String01Main {
	...
	public static void main(String[] args) {
		...
		str1 = str1.concat(str2); // 변경하려면 이와 같이 덮어쓰기를 해야합니다.
		System.out.println(str1);
		System.out.println();
		...
		System.out.println("str3 길이: " + str3.length());
		...
		//System.out.println(str1.charAt(20)); // 범위를 초가 StringIndexOutOfBoundsException 오류

		System.out.println();
		System.out.println("indexOf(char), indexOf(String)"); // 문자열 안에서 특정 문자(char) 혹은 문자열(String)의 위치(index), 발견 못하면
																// -1 리턴
	    System.out.println(str1.indexOf('c'));
	    System.out.println(str2.indexOf('하'));
		...
		String[] strings = str4.split(":"); // : 기준으로 쪼갠다. 
		...
		System.out.println();
		System.out.println("substring(beginIndex, endIndex)"); // 문자열의 일부분 추출 beginIndex ~ endIndex직전 까지, 인덱스 범위 벗어마면
		...
		System.out.println();
		System.out.println("replaceAll(regex, replacement), replaceFirst(regex, replacement)"); // 정규표현식 사용버젼 ,
		System.out.println(str10.replaceAll("Language", "자바"));
		System.out.println(str10.replaceFirst("Language", "자바"));                               // replaceAll() 매칭되는것 전부
																								// 치환, replaceFirst()
																								// 첫매칭만 치환
