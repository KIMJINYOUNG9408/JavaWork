...
public class Wrapper02Main {
	...
	public static void main(String[] args) {
		...
		Integer num1 = 10; // Integer.valueOf(10)이 내부적으로 동작하는 것. < -- auto- boxing
		Integer num2 = 20;  // auto - boxing
		System.out.println(num1 + num2); // 10 과 20을 꺼낸다 자동적으로  >> auto-unboxing
		System.out.println(num1.intValue() + num2.intValue()); //  <-- 이와 같이 동작
		
		System.out.println();
		System.out.println("boxing/unboxing");
		
		Integer num3 = num1 + num2;     // 아래와 같이동작 언방식해서 꺼낸다음 더하고 박싱해서 넣어준다.↓
		...
		Double num200 = 3.14; // Dobule.valueOf(3.14)
