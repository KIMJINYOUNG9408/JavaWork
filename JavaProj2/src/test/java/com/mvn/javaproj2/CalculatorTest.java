...
public class CalculatorTest {
	...
	// JUnit 은 멤버 필드 방식을 비추한다 --> 테스트 결과가 다른 테스트 결과에 영향을 줄 수 있다
	...
	public void testAdd() {
		...
		assertEquals(30, result); // expected( 예상 값 ) , 비교하는 값.
	}
	...
	public void testSub() {
		...
		assertEquals(-10, result); // expected( 예상 값 ) , 비교하는 값.
	}
	...
	public void testMul() {
		...
		assertEquals(200, result); // expected( 예상 값 ) , 비교하는 값.
	}
	...
	public void testDiv() {
		...
		assertEquals(0, result); // expected( 예상 값 ) , 비교하는 값.
	}
