...
public interface Pb {
	...
	// 1. Oracle 연동을 위한 정보들(상수들)을 정의(세팅)
        ...
        public static final String SQL_UPDATE_BY_UID = "UPDATE " + TBL_NAME + " SET "
        		+ COL_LABEL_NAME + " = ?, "
        		+ COL_LABEL_PHONENUM + " = ?, " 
        		+ COL_LABEL_MEMO + " = ? "
        		+ "WHERE " + COL_LABEL_UID + " = ?"
        ...
        public static final String SQL_SELECT_MAX_UID = "SELECT MAX(" + COL_LABEL_UID + ") pb_uid FROM " + TBL_NAME ;
