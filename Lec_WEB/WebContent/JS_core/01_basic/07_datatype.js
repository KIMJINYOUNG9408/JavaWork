...
// true / false
{
    ...
    if(a){ // <-- new 를 사용하여 생성하면 조건식에서 '참'으로 판정된다. 그치만 a를 >> a==true 하면 되더라.
        console.log(a, '참입니다');
    } else {
        console.log(a, '거짓입니다');
    }
...
console.log('\n<undefined>')
{
    ...
    if(a === b) { // === : 값 뿐 아니라 타입까지 비교
        console.log('=== 같습니다')
    } else {
        console.log('=== 다릅니다.')
    }
    // 가급적 JS 프로그래밍에 작성 == 보단 === 추천
    // != 보단 !== 추천
}
...
console.log('\n<String>')
{
    ...
    console.log("AAaa" > "AaAa") // false : 대문자 보다 소문자가 크다.
